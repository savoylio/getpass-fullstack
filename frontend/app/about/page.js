    ...
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto px-4 py-12 w-full">
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100">
          <h1 className="text-3xl font-extrabold text-gray-900 mb-6">关于 GetPass Pro</h1>
          <div className="prose prose-indigo max-w-none text-gray-600 leading-relaxed space-y-4">
            <p className="text-lg font-medium text-indigo-900">GetPass Pro 为英美概况 2 打造</p>
            <p><strong>开发者：</strong> Kit Liu（刘思特）</p>
            <p>
              GetPass Pro 是由 Kit 为 2023 级英美概况 2 课程期末复习自主开发的进阶版在线学习系统。
            ...
            <p>
              GetPass Pro 致力于提供 <strong>简洁、直观、有效</strong> 的备考体验。
